...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/models/Collections.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUserCollection = function () {
    return new Collections_1.Collection('http://localhost:3000/users', function (json) {
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Collections":"src/models/Collections.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collections":"src/models/Collections.ts","./models/User":"src/models/User.ts"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
